...
public class NodaTimeTests : TestBase, IDisposable
{
    ...
    public Task Timestamp_as_unspecified_DateTime()
        => AssertType(
            ...
            dbType: DbType.DateTime2, valueTypeEqualsFieldType: false);
    ...
    public Task Timestamp_cannot_write_utc_DateTime()
        => AssertTypeUnsupportedWrite<DateTime, InvalidCastException>(new DateTime(1998, 4, 12, 13, 26, 38, DateTimeKind.Utc), "timestamp without time zone");
    ...
    public async Task Tsrange_as_NpgsqlRange_of_LocalDateTime()
    {
        ...
        await AssertType(
            new [] { new NpgsqlRange<LocalDateTime>(
                ...
                new(1998, 4, 12, 15, 26, 38)), },
            """{["1998-04-12 13:26:38","1998-04-12 15:26:38"]}""",
            "tsmultirange", dataTypeInference: DataTypeInference.Nothing, skipArrayCheck: true);
    }
    ...
    public async Task Timestamptz_cannot_write_non_utc_ZonedDateTime()
        => await AssertTypeUnsupportedWrite<ZonedDateTime, InvalidCastException>(
    ...
    public async Task Timestamptz_cannot_write_non_utc_OffsetDateTime()
        => await AssertTypeUnsupportedWrite<OffsetDateTime, InvalidCastException>(new LocalDateTime().WithOffset(Offset.FromHours(2)), "timestamp with time zone");

    [Test]
    public async Task Timestamptz_cannot_write_non_utc_DateTime()
    {
        await AssertTypeUnsupportedWrite<DateTime, InvalidCastException>(new DateTime(1998, 4, 12, 13, 26, 38, DateTimeKind.Unspecified), "timestamp with time zone");
        await AssertTypeUnsupportedWrite<DateTime, InvalidCastException>(new DateTime(1998, 4, 12, 13, 26, 38, DateTimeKind.Local), "timestamp with time zone");
    }
    ...
    public async Task Tstzrange_as_Interval()
    {
         ...
         await AssertType(
            new [] { new Interval(
                ...
                new LocalDateTime(1998, 4, 12, 15, 26, 38).InUtc().ToInstant()), },
            """{"[\"1998-04-12 15:26:38+02\",\"1998-04-12 17:26:38+02\")"}""",
            "tstzrange[]", dataTypeInference: DataTypeInference.Nothing, skipArrayCheck: true);
         ...
         await AssertType(
             new [] { new Interval(
                 ...
                 new LocalDateTime(1998, 4, 12, 15, 26, 38).InUtc().ToInstant()), },
             """{["1998-04-12 15:26:38+02","1998-04-12 17:26:38+02")}""",
             "tstzmultirange", dataTypeInference: DataTypeInference.Nothing, skipArrayCheck: true);
    }
    ...
    public Task Tstzrange_with_no_start_or_end_as_Interval()
        => AssertType(
            ...
            """(,)""",
            "tstzrange",
            dataTypeInference: DataTypeInference.Nothing, skipArrayCheck: true);
    ...
    public async Task Tstzmultirange_as_array_of_Interval()
    {
        ...
        await AssertType(
            ...
            "tstzmultirange", dataTypeInference: DataTypeInference.Nothing);
    }
    ...
    public Task Date_as_LocalDate()
        => AssertType(new LocalDate(2020, 10, 1), "2020-10-01",
            "date", dataTypeInference: DataTypeInference.Nothing,
    ...
    public async Task Daterange_as_DateInterval()
    {
        await AssertType(
            ...
            "daterange",
            dataTypeInference: DataTypeInference.Nothing, skipArrayCheck: true); // DateInterval<T>[] is mapped to multirange by default, not array; test separately
        ...
        await AssertType(
            new [] {new DateInterval(new(2002, 3, 4), new(2002, 3, 6))},
            """{[2002-03-04,2002-03-07)}""",
            "datemultirange", dataTypeInference: DataTypeInference.Nothing,
            skipArrayCheck: true);
    }
    ...
    public Task Date_as_DateOnly()
        => AssertType(new DateOnly(2020, 10, 1), "2020-10-01", "date", dbType: DbType.Date, valueTypeEqualsFieldType: false);
    ...
    public async Task Daterange_array_as_array_of_NpgsqlRange_of_LocalDate()
    {
        ...
        await AssertType(
            ...
            """{"[2002-03-04,2002-03-06)","[2002-03-08,2002-03-11)"}""",
            "daterange[]", dataTypeInference: DataTypeInference.Nothing, valueTypeEqualsFieldType: false);
    }
    ...
    public Task Time_as_LocalTime()
        => AssertType(new LocalTime(10, 45, 34, 500), "10:45:34.5",
            "time without time zone", dataTypeInference: DataTypeInference.Nothing,
    ...
    public async Task TimeTz_as_DateTimeOffset()
    {
        await AssertTypeRead(
            "13:03:45.51+02",
            "time with time zone",
            new DateTimeOffset(1, 1, 2, 13, 3, 45, 510, TimeSpan.FromHours(2)), valueTypeEqualsFieldType: false);
    ...
    public Task Interval_as_Duration()
        => AssertType(
            ...
            "interval", dataTypeInference: DataTypeInference.Nothing,
            valueTypeEqualsFieldType: false);
