    ...
    : PgTypeInfoResolverFactory
{
        ...
        : DynamicTypeInfoResolver, IPgTypeInfoResolver
    {
        ...
        protected TypeInfoMappingCollection Mappings => _mappings ??= AddMappings(new(), jsonbClrTypes ?? Array.Empty<Type>(), jsonClrTypes ?? Array.Empty<Type>(), _serializerSettings);
