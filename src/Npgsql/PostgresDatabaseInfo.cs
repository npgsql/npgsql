...
namespace Npgsql
{
    ...
    class PostgresDatabaseInfo : NpgsqlDatabaseInfo
    {
        ...
        /// <inheritdoc />
        public override bool SupportsUnlisten => Version.IsGreaterOrEqual(6, 4, 0) && !IsRedshift;

        /// <summary>
        /// True if the 'pg_enum' table includes the 'enumsortorder' column; otherwise, false.
        /// </summary>
        public virtual bool HasEnumSortOrder => Version.IsGreaterOrEqual(9, 1, 0);
        ...
        /// </remarks>
        public virtual bool HasTypeCategory => Version.IsGreaterOrEqual(8, 4, 0);
