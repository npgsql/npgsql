...
connection.Open();*/
    ...
    [TestFixture]
    public class CommandTestsV2 : BaseClassTests
    {
        ...
        public void EmptyQuery()
        {
            ...
            NpgsqlCommand command = new NpgsqlCommand(";", _connV2);
            command.ExecuteNonQuery();
        }
        ...
        public void FunctionCallFromSelect()
        {
            NpgsqlCommand command = new NpgsqlCommand("select * from funcB()", _connV2);
        ...
        public void ExecuteScalar()
        {
            NpgsqlCommand command = new NpgsqlCommand("select count(*) from tablea", _connV2);
        ...
        public void InsertStringWithBackslashes()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_text) values (:p0)", _connV2);
            ...
            NpgsqlCommand command2 = new NpgsqlCommand("select field_text from tablea where field_serial = (select max(field_serial) from tablea)", _connV2);
        ...
        public void UseIntegerParameterWithNoNpgsqlDbType()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_int4) values (:p0)", _connV2);
            ...
            NpgsqlCommand command2 = new NpgsqlCommand("select field_int4 from tablea where field_serial = (select max(field_serial) from tablea)", _connV2);
        ...
        public void FunctionCallReturnSingleValue()
        {
            NpgsqlCommand command = new NpgsqlCommand("funcC();", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void FunctionCallWithParametersReturnSingleValue()
        {
            NpgsqlCommand command = new NpgsqlCommand("funcC(:a)", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void CursorStatement()
        {
            ...
            NpgsqlCommand command = new NpgsqlCommand("declare te cursor for select * from tablea;", _connV2);
        ...
        public void RTFStatementInsert()
        {
            ...
            String result = (String)new NpgsqlCommand("select field_text from tablea where field_serial = (select max(field_serial) from tablea);", _connV2).ExecuteScalar();
        ...
        public void PreparedStatementWithParameters()
        {
            NpgsqlCommand command = new NpgsqlCommand("select * from tablea where field_int4 = :a and field_int8 = :b;", _connV2);
        ...
        public void FunctionReturnVoid()
        {
			NpgsqlCommand command = new NpgsqlCommand("testreturnvoid()", _connV2);
            command.CommandType = CommandType.StoredProcedure;
            command.ExecuteNonQuery();
        }
        ...
        public void StatementOutputParameters()
        {
            NpgsqlCommand command = new NpgsqlCommand("select 4, 5;", _connV2);
        ...
        public void StatementMappedOutputParameters()
        {
            NpgsqlCommand command = new NpgsqlCommand("select 3, 4 as param1, 5 as param2, 6;", _connV2);
        ...
        public void ListenNotifySupport()
        {
            ...
            _tV2.Rollback(); _tV2 = null;
            
            Assert.IsFalse(RecievedNotification);//Test we start correctly.

            NpgsqlCommand command = new NpgsqlCommand("listen notifytest;", _connV2);
            command.ExecuteNonQuery();

            _connV2.Notification += new NotificationEventHandler(NotificationSupportHelper);


            command = new NpgsqlCommand("notify notifytest;", _connV2);
            command.ExecuteNonQuery();
        ...
        public void ByteSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tableb(field_int2) values (:a)", _connV2);
        ...
        public void ByteaInsertSupport()
        {
            Byte[] toStore = { 1 };
  		    	...
  		    	NpgsqlCommand cmd = new NpgsqlCommand("insert into tablef(field_bytea) values (:val)", _connV2);
      	    cmd.Parameters.Add(new NpgsqlParameter("val", DbType.Binary));
  		    	cmd.Parameters[0].Value = toStore;
      			cmd.ExecuteNonQuery();

  	  	  	cmd = new NpgsqlCommand("select field_bytea from tablef where field_serial = (select max(field_serial) from tablef)", _connV2);
        ...
        public void ByteaParameterSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_bytea from tablef where field_bytea = :bytesData", _connV2);
        ...
        public void DateTimeSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_timestamp from tableb where field_serial = 2;", _connV2);
        ...
        public void DateSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_date from tablec where field_serial = 1;", _connV2);
        ...
        public void TimeSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_time from tablec where field_serial = 2;", _connV2);
        ...
        public void DateTimeSupportTimezone()
        {
            NpgsqlCommand command = new NpgsqlCommand("set time zone 5;select field_timestamp_with_timezone from tableg where field_serial = 1;", _connV2);
        ...
        public void NumericSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tableb(field_numeric) values (:a)", _connV2);
            command.Parameters.Add(new NpgsqlParameter("a", DbType.Decimal));
        ...
        public void InsertSingleValue()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tabled(field_float4) values (:a)", _connV2);
            command.Parameters.Add(new NpgsqlParameter(":a", DbType.Single));
        ...
        public void DoubleValueSupportWithExtendedQuery()
        {
            NpgsqlCommand command = new NpgsqlCommand("select count(*) from tabled where field_float8 = :a", _connV2);
            command.Parameters.Add(new NpgsqlParameter(":a", NpgsqlDbType.Double));
        ...
        public void InsertDoubleValue()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tabled(field_float8) values (:a)", _connV2);
            command.Parameters.Add(new NpgsqlParameter(":a", DbType.Double));
        ...
        public void NegativeNumericSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select * from tableb where field_serial = 4", _connV2);
        ...
        public void InsertNullString()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_text) values (:a)", _connV2);
        ...
        public void InsertNullDateTime()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tableb(field_timestamp) values (:a)", _connV2);
        ...
        public void InsertNullInt32()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_int4) values (:a)", _connV2);
        ...
        public void InsertNullBoolean()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_bool) values (:a)", _connV2);
        ...
        public void MultipleQueriesFirstResultsetEmpty()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablea(field_text) values ('a'); select count(*) from tablea;", _connV2);
        ...
        public void ConnectionStringWithInvalidParameterValue()
        {
            NpgsqlConnection conn = new NpgsqlConnection("Server=127.0.0.1;User Id=npgsql_tV2ets;Password=j");
        ...
        public void InvalidConnectionString()
        {
            NpgsqlConnection conn = new NpgsqlConnection("Server=127.0.0.1;User Id=npgsql_tV2ests;Pooling:false");
        ...
        public void AmbiguousFunctionParameterType()
        {
            NpgsqlConnection conn = new NpgsqlConnection(_connV2String);
        ...
        public void TestParameterReplace()
        {
            ...
            NpgsqlCommand command = new NpgsqlCommand(sql, _connV2);
        ...
        public void TestParameterNameInParameterValue()
        {
            ...
            NpgsqlCommand command2 = new NpgsqlCommand("select field_text, field_int4 from tablea where field_serial = (select max(field_serial) from tablea)", _connV2);
        ...
        public void TestPointSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_point from tablee where field_serial = 1", _connV2);
        ...
        public void TestBoxSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_box from tablee where field_serial = 2", _connV2);
        ...
        public void TestLSegSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_lseg from tablee where field_serial = 3", _connV2);
        ...
        public void TestClosedPathSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_path from tablee where field_serial = 4", _connV2);
        ...
        public void TestOpenPathSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_path from tablee where field_serial = 5", _connV2);
        ...
        public void TestPolygonSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_polygon from tablee where field_serial = 6", _connV2);
        ...
        public void TestCircleSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("select field_circle from tablee where field_serial = 7", _connV2);
        ...
        public void TestCharParameterLength()
        {
            ...
            NpgsqlCommand command2 = new NpgsqlCommand("select field_char5 from tableh where field_serial = (select max(field_serial) from tableh)", _connV2);
        ...
        public void ParameterHandlingOnQueryWithParameterPrefix()
        {
            NpgsqlCommand command = new NpgsqlCommand("select to_char(field_time, 'HH24:MI') from tablec where field_serial = :a;", _connV2);
        ...
        public void MultipleRefCursorSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("testmultcurfunc", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void ProcedureNameWithSchemaSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("public.testreturnrecord", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void ReturnRecordSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("testreturnrecord", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void ReadUncommitedTransactionSupport()
        {
            ...
            NpgsqlConnection c = new NpgsqlConnection(_connV2String);
        ...
        public void LastInsertedOidSupport()
        {
            ...
            NpgsqlCommand insertCommand = new NpgsqlCommand("insert into tablea(field_text) values ('a');", _connV2);
            // Insert this dummy row, just to enable us to see what was the last oid in order we can assert it later.
            insertCommand.ExecuteNonQuery();

            NpgsqlCommand selectCommand = new NpgsqlCommand("select max(oid) from tablea;", _connV2);     
        ...
        public void SetServerVersionToNull()
        {
            ...
            ServerVersion o = _connV2.ServerVersion;
        ...
        public void VerifyFunctionNameWithDeriveParameters()
        {
            try
            {
                NpgsqlCommand invalidCommandName = new NpgsqlCommand("invalidfunctionname", _connV2);
        ...
        public void ReturnInfinityDateTimeSupportNpgsqlDbType()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tableb(field_timestamp) values ('infinity'::timestamp);", _connV2);
            

            command.ExecuteNonQuery();
            
            
            command = new NpgsqlCommand("select field_timestamp from tableb where field_serial = (select max(field_serial) from tableb);", _connV2);
        ...
        public void InetTypeSupport()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablej(field_inet) values (:a);", _connV2);
            ...
            command = new NpgsqlCommand("select field_inet from tablej where field_serial = (select max(field_serial) from tablej);", _connV2);
        ...
        public void BitTypeSupportWithPrepare()
        {
            NpgsqlCommand command = new NpgsqlCommand("insert into tablek(field_bit) values (:a);", _connV2);
            ...
            command = new NpgsqlCommand("select field_bit from tablek where field_serial = (select max(field_serial) from tablek);", _connV2);
        ...
        public void FunctionReceiveCharParameter()
        {
            NpgsqlCommand command = new NpgsqlCommand("d/;", _connV2);
        ...
        public void FunctionCaseSensitiveName()
        {
            NpgsqlCommand command = new NpgsqlCommand("\"FunctionCaseSensitive\"", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void FunctionCaseSensitiveNameWithSchema()
        {
            NpgsqlCommand command = new NpgsqlCommand("\"public\".\"FunctionCaseSensitive\"", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void FunctionTestTimestamptzParameterSupport()
        {
            ...
            NpgsqlCommand command = new NpgsqlCommand("testtimestamptzparameter", _connV2);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public void GreaterThanInQueryStringWithPrepare()
        {
            NpgsqlCommand command = new NpgsqlCommand("select count(*) from tablea where field_serial >:param1", _connV2);
...
connection.Open();*/
        ...
        NpgsqlConnection conn = new NpgsqlConnection(_connV2String + ";CommandTimeout=180");
        NpgsqlCommand command = new NpgsqlCommand("\"Foo\"", conn);
        conn.Open();
