...
namespace Npgsql.Properties {
    ...
    internal class NpgsqlStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to When registering a credentials provider a username, password or passfile may not be set..
        /// </summary>
        internal static string CannotSetBothCredentialsProviderAndPasswordOrUsername {
            get {
                return ResourceManager.GetString("CannotSetBothCredentialsProviderAndPasswordOrUsername", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Both a credentials provider and a password provider found, only one kind may be configured per DbDataSource..
        /// </summary>
        internal static string CannotSetCredentialProviderAndPasswordProvider {
            get {
                return ResourceManager.GetString("CannotSetCredentialProviderAndPasswordProvider", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Both sync and async credentials providers must be provided..
        /// </summary>
        internal static string SyncAndAsyncCredentialsProvidersRequired {
            get {
                return ResourceManager.GetString("SyncAndAsyncCredentialsProvidersRequired", resourceCulture);
            }
        }
