...
namespace NpgsqlTypes
{
    ...
    public readonly struct NpgsqlLogSequenceNumber : IEquatable<NpgsqlLogSequenceNumber>, IComparable<NpgsqlLogSequenceNumber>
    {
        ...
        public override bool Equals(object? obj)
            => obj is NpgsqlLogSequenceNumber lsn && lsn._value.Equals(_value);
        ...
        /// <returns>
        /// A <see cref="NpgsqlLogSequenceNumber"/> equivalent to the Log Sequence Number specified in <c>s</c>.
        /// </returns>
        ...
        public static NpgsqlLogSequenceNumber Parse(string s)
            // We certainly want to play it safe on a public API
...
#endif
                    return new NpgsqlLogSequenceNumber(((ulong)uint.Parse(firstPart, NumberStyles.AllowHexSpecifier) << 32) + uint.Parse(secondPart, NumberStyles.AllowHexSpecifier));
                }
            }
        ...
        /// <summary>
        /// Tries to convert the string representation of a Log Sequence Number to a <see cref="NpgsqlLogSequenceNumber"/>
        ...
        /// <see cref="NpgsqlLogSequenceNumber"/> (<c>0</c>) if the conversion failed. The conversion fails if the <c>s</c>
        ...
        /// <summary>
        /// Tries to convert the span representation of a Log Sequence Number to a <see cref="NpgsqlLogSequenceNumber"/>
        /// instance. A return value indicates whether the conversion succeeded or failed.
        /// </summary>
        /// <param name="s">A span containing the characters that represent the Log Sequence Number to convert.</param>
        /// <param name="result">
        ...
        /// <returns>A new instance of <see cref="NpgsqlLogSequenceNumber"/> initialized to <c>value</c>.</returns>
        [PublicAPI]
