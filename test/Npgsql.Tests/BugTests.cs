...
namespace Npgsql.Tests
{
    public class BugTests : TestBase
    {
        ...
        public void SequentialNullCheckOnNonFirstField()
        {
            ...
            using var rdr = cmd.ExecuteFirstRecord(CommandBehavior.SequentialAccess);
            Assert.That(rdr.IsDBNull(1), Is.True);
        }
        ...
        public void SequentialSkipOverFirstRow()
        {
            ...
            Assert.That(rdr.NextResult(), Is.True);
            Assert.That(rdr.Read(), Is.True);
            Assert.That(rdr.GetInt32(0), Is.EqualTo(2));
        }
        ...
        public void RecordWithNonIntField()
        {
            ...
            var record = rdr.GetFieldValue<object[]>(0);
        ...
        public void Bug1700() => Assert.That(() =>
            {
                using var conn = OpenConnection();
        ...
        public void Bug1986()
        {
            ...
            using (var textReader1 = rdr.GetTextReader(0))
            {
            }

            using (var textReader2 = rdr.GetTextReader(1))
            {
            }
        }
        ...
        public void Bug2003()
        {
            ...
            using var rdr = cmd.ExecuteFirstRecord(CommandBehavior.SequentialAccess);
            Assert.That(rdr.GetInt32(0), Is.EqualTo(8));
        }
