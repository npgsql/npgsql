...
sealed partial class AdoTypeInfoResolverFactory
{
    ...
    class MultirangeResolver : IPgTypeInfoResolver
    {
        ...
        static TypeInfoMappingCollection AddMappings(TypeInfoMappingCollection mappings)
        {
            ...
            {
                mappings.AddProviderType<NpgsqlRange<DateTime>[]>(DataTypeNames.TsMultirange,
                    static (options, mapping, requiresDataTypeName) => mapping.CreateInfo(options,
                        DateTimeTypeInfoProvider.CreateMultirangeProvider<NpgsqlRange<DateTime>[], NpgsqlRange<DateTime>>(options,
            ...
            {
                mappings.AddProviderType<NpgsqlRange<DateTime>[]>(DataTypeNames.TsTzMultirange,
                    static (options, mapping, requiresDataTypeName) => mapping.CreateInfo(options,
                        DateTimeTypeInfoProvider.CreateMultirangeProvider<NpgsqlRange<DateTime>[], NpgsqlRange<DateTime>>(options,
                            options.GetCanonicalTypeId(DataTypeNames.TsTzMultirange),
                            options.GetCanonicalTypeId(DataTypeNames.TsMultirange),
    ...
    sealed class MultirangeArrayResolver : MultirangeResolver, IPgTypeInfoResolver
    {
        ...
        static TypeInfoMappingCollection AddMappings(TypeInfoMappingCollection mappings)
        {
            ...
            {
                mappings.AddProviderArrayType<NpgsqlRange<DateTime>[]>(DataTypeNames.TsMultirange);
                mappings.AddProviderArrayType<List<NpgsqlRange<DateTime>>>(DataTypeNames.TsMultirange);
            }
            ...
            {
                mappings.AddProviderArrayType<NpgsqlRange<DateTime>[]>(DataTypeNames.TsTzMultirange);
                mappings.AddProviderArrayType<List<NpgsqlRange<DateTime>>>(DataTypeNames.TsTzMultirange);
                mappings.AddArrayType<NpgsqlRange<DateTimeOffset>[]>(DataTypeNames.TsTzMultirange);
                mappings.AddArrayType<List<NpgsqlRange<DateTimeOffset>>>(DataTypeNames.TsTzMultirange);
            }
