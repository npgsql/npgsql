...
public sealed class TypeInfoMappingCollection
{
    ...
    static ArrayConverter<Array> CreateArrayBasedConverter<TElement>(TypeInfoMapping mapping, PgTypeInfo elemInfo)
    {
        if (!elemInfo.IsBoxing)
            return ArrayConverter<Array>.CreateArrayBased<TElement>(elemInfo.AsConcreteTypeInfo(), mapping.Type);
    ...
    {
        if (!elemInfo.IsBoxing)
            return ArrayConverter<IList<TElement>>.CreateListBased<TElement>(elemInfo.AsConcreteTypeInfo());
