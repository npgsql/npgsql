...
Write-Host Enabling PostgreSQL Logical Replication...
Add-Content 'C:\Program Files\PostgreSQL\10\data\postgresql.conf' "`nwal_level = logical"
Add-Content 'C:\Program Files\PostgreSQL\10\data\postgresql.conf' "`nmax_replication_slots = 1"
