...
public sealed class NpgsqlConnection : DbConnection, ICloneable, IComponent
{
    ...
    ValueTask<NpgsqlTransaction> BeginTransaction(IsolationLevel level, bool async, CancellationToken cancellationToken)
    {
        ...
        return new(connector.Transaction);
    }
    ...
    /// </remarks>
    /// </summary>
    public override string ServerVersion => CheckOpenAndRunInTemporaryScope(c => c.DatabaseInfo.ServerVersion);
    ...
    /// </summary>
    [Browsable(false)]
    public IReadOnlyDictionary<string, string> PostgresParameters => CheckOpenAndRunInTemporaryScope(c => c.PostgresParameters);
