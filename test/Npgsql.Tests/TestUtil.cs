...
public static class TestUtil
{
    ...
    public const string DefaultConnectionString =
        "Host=localhost;Username=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=15;Command Timeout=15;SSL Mode=Disable;Multiplexing=False;GSS Encryption Mode=Disable";
