...
sealed class BitArrayBitStringConverter : PgStreamingConverter<BitArray>
{
    ...
    protected override Size GetSize(SizeContext context, BitArray value, ref object? writeState)
...
sealed class BoolBitStringConverter : PgBufferedConverter<bool>
{
    ...
    protected override Size GetSize(SizeContext context, bool value, ref object? writeState) => MaxSize;
...
sealed class StringBitStringConverter : PgStreamingConverter<string>
{
    ...
    protected override Size GetSize(SizeContext context, string value, ref object? writeState)
    {
...
/// For BIT(1) columns specifically (read from a field with TypeModifier == 1), this provider returns a bool converter
/// to align with SqlClient (see discussion https://github.com/npgsql/npgsql/pull/362#issuecomment-59622101).
