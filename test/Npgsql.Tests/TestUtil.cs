...
public static class TestUtil
{
    ...
    public const string DefaultConnectionString =
        "Host=localhost;Username=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;Timeout=0;Command Timeout=0;SSL Mode=Disable;Multiplexing=False;GSS Encryption Mode=Disable";
