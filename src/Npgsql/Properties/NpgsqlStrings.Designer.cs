...
namespace Npgsql.Properties {
    ...
    internal class NpgsqlStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to To validate server certificates, please use VerifyFull or VerifyCA instead of Require. To disable validation, explicitly set &apos;Trust Server Certificate&apos; to true. See https://www.npgsql.org/doc/release-notes/6.0.html for more details..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to TrustServerCertificate=true is not supported with SslMode={0}.
        /// </summary>
