...
public class JsonSourceGeneratedTests : MultiplexingTestBase
{
    [Test]
    ...
    [Test]
    public async Task As_poco_supported_only_with_EnableSourceGeneratedJson()
    {
        // This test uses base.DataSource, which doesn't have EnableSourceGeneratedJson()
    ...
    {
        var jsonWithContext = new Dictionary<Type, JsonSerializerContext>
            { { typeof(WeatherForecast), WeatherForecastJsonSerializerContext.Default } };

        var dataSource = CreateDataSourceBuilder()
            .EnableSourceGeneratedJson(jsonWithContext, jsonWithContext)
            .Build();
        var sqlLiteral =
            IsJsonb
                ? """{"Date": "2019-09-01T00:00:00", "Summary": "Partly cloudy", "TemperatureC": 10}"""
    ...
    public async Task Poco_default_mapping()
    {
        ...
        if (IsJsonb)
            dataSourceBuilder.EnableSourceGeneratedJson(jsonbClrTypes: jsonWithContext);
        else
            dataSourceBuilder.EnableSourceGeneratedJson(jsonClrTypes: jsonWithContext);
    ...
    public async Task Poco_polymorphic_mapping()
    {
        ...
        {
            { typeof(WeatherForecast), WeatherForecastJsonSerializerContext.Default },
            { typeof(ExtendedDerivedWeatherForecast), ExtendedDerivedWeatherForecastJsonSerializerContext.Default }
        };
    ...
    public async Task Poco_polymorphic_mapping_read_parents()
    {
        ...
        {
            { typeof(WeatherForecast), WeatherForecastJsonSerializerContext.Default },
            { typeof(DerivedWeatherForecast), DerivedWeatherForecastJsonSerializerContext.Default },
            { typeof(ExtendedDerivedWeatherForecast), ExtendedDerivedWeatherForecastJsonSerializerContext.Default }
        };
    ...
    public class DerivedWeatherForecast : WeatherForecast
    {
    }

    public class ExtendedDerivedWeatherForecast : DerivedWeatherForecast
    {
        public int TemperatureF => 32 + (int)(TemperatureC / 0.5556);
    }

    public JsonSourceGeneratedTests(MultiplexingMode multiplexingMode, NpgsqlDbType npgsqlDbType)
        : base(multiplexingMode)
    {
        ...
        DataSource = CreateDataSource(b => b.EnableSourceGeneratedJson(jsonWithContext, jsonWithContext));
...
[JsonSerializable(typeof(JsonSourceGeneratedTests.WeatherForecast))]
[JsonSerializable(typeof(JsonSourceGeneratedTests.ExtendedDerivedWeatherForecast))]
public partial class WeatherForecastJsonSerializerContext : JsonSerializerContext;

[JsonSerializable(typeof(JsonSourceGeneratedTests.WeatherForecast))]
[JsonSerializable(typeof(JsonSourceGeneratedTests.DerivedWeatherForecast))]
public partial class DerivedWeatherForecastJsonSerializerContext : JsonSerializerContext;

[JsonSerializable(typeof(JsonSourceGeneratedTests.WeatherForecast))]
[JsonSerializable(typeof(JsonSourceGeneratedTests.ExtendedDerivedWeatherForecast))]
public partial class ExtendedDerivedWeatherForecastJsonSerializerContext : JsonSerializerContext;
