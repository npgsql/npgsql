...
public sealed class TypeInfoMappingCollection
{
        ...
        Func<Type?, bool>? typeMatchPredicate, Func<Type?, bool>? nullableTypeMatchPredicate, bool suppressObjectMapping)
    {
        ...
        PgTypeInfo CreateComposedPerInstance(PgTypeInfo innerTypeInfo, PgTypeInfo nullableInnerTypeInfo, string dataTypeName)
        {
            ...
            return new PgConcreteTypeInfo(innerTypeInfo.Options, converter,
                innerTypeInfo.Options.GetCanonicalTypeId(new DataTypeName(dataTypeName)), reportedType: typeof(object)) { SupportsWriting = false };
        }
    }
    ...
    void AddProviderStructArrayType(TypeInfoMapping elementMapping, TypeInfoMapping nullableElementMapping, Type type, Type nullableType,
            ...
            bool suppressObjectMapping, Func<Type?, bool>? typeMatchPredicate, Func<Type?, bool>? nullableTypeMatchPredicate)
        {
            ...
            {
                var provider =
                    new PolymorphicArrayTypeInfoProvider<Array>((PgProviderTypeInfo)innerTypeInfo,
                        (PgProviderTypeInfo)nullableInnerTypeInfo);

                return new PgProviderTypeInfo(innerTypeInfo.Options, provider,
